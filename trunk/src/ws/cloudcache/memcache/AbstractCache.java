...
import ws.cloudcache.memcache.marshallers.JAXBMarshaller;
import ws.cloudcache.memcache.marshallers.Marshaller;
...
public abstract class AbstractCache implements BigCache {
    ...
    private void checkExecutor() {
        if (executorService == null) {
            throw new CloudCacheRuntimeException("ExecutorService is null. Can not perform operation.");
        }
    }
